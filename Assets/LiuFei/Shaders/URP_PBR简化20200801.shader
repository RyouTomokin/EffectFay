	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord53 = input.ase_texcoord8.xyz.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half3 desaturateVar86 = lerp( desaturateInitialColor86, desaturateDot86.xxx, 1.0 );
				half temp_output_88_0 = (desaturateVar86).x;
				half2 texCoord53 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				half2 appendResult56 = (half2(( _OpacityMaskTexU * _TimeParameters.x ) , ( _TimeParameters.x * _OpacityMaskTexV )));
				half3 desaturateInitialColor82 = tex2D( _OpacityMaskTex, (( _OffsetMaxTexFrequencyToOpacityMaskTex )?( ( appendResult54 + texCoord53 ) ):( ( texCoord53 + appendResult56 ) )) ).rgb;
				half desaturateDot82 = dot( desaturateInitialColor82, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar82 = lerp( desaturateInitialColor82, desaturateDot82.xxx, 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				half3 desaturateVar86 = lerp( desaturateInitialColor86, desaturateDot86.xxx, 1.0 );
				half temp_output_88_0 = (desaturateVar86).x;
				half2 texCoord53 = input.ase_texcoord4.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				half2 appendResult56 = (half2(( _OpacityMaskTexU * _TimeParameters.x ) , ( _TimeParameters.x * _OpacityMaskTexV )));
				half3 desaturateInitialColor82 = tex2D( _OpacityMaskTex, (( _OffsetMaxTexFrequencyToOpacityMaskTex )?( ( appendResult54 + texCoord53 ) ):( ( texCoord53 + appendResult56 ) )) ).rgb;
				half desaturateDot82 = dot( desaturateInitialColor82, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar82 = lerp( desaturateInitialColor82, desaturateDot82.xxx, 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				half3 desaturateVar86 = lerp( desaturateInitialColor86, desaturateDot86.xxx, 1.0 );
				half temp_output_88_0 = (desaturateVar86).x;
				half2 texCoord53 = input.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				half2 appendResult56 = (half2(( _OpacityMaskTexU * _TimeParameters.x ) , ( _TimeParameters.x * _OpacityMaskTexV )));
				half3 desaturateInitialColor82 = tex2D( _OpacityMaskTex, (( _OffsetMaxTexFrequencyToOpacityMaskTex )?( ( appendResult54 + texCoord53 ) ):( ( texCoord53 + appendResult56 ) )) ).rgb;
				half desaturateDot82 = dot( desaturateInitialColor82, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar82 = lerp( desaturateInitialColor82, desaturateDot82.xxx, 1.0 );
...
Node;AmplifyShaderEditor.SamplerNode;76;-2091.381,1421.414;Inherit;True;Property;_OpacityMaskTex;OpacityMaskTex;28;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=445039AE2BDF13EC7232EAA539507BF0B461F4AE